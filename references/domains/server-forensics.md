...
For a **local file or disk image** (APK, PCAP, SQLite/SQL dump, registry, E01, browser export), use DFTK's 71 read-only tools. DFTK does not provide live-host collection tools.
