...
This release is designed to work with DFTK 3.1 native MCP or the existing DFTK CLI. It deliberately does not implement an Agent runtime, case-question state machine, or challenge-specific solver.
